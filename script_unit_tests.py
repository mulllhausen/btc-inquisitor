...
human_scripts = {
	...
	0: {
		"later_tx": {
			...
			"input": {
				0: {
					...
					"index": 0,
					"parsed_script": "OP_PUSHDATA0(71) 304402204e45e16932b8af514961a1d3a1a25fdf3f4f7732e9d624c6c61548ab5fb8cd410220181522ec8eca07de4860a4acdd12909d831cc56cbbac4622082221a8768d1d0901", # push signature
					"script_length": 72,
			...
			"output": {
				0: {
					"funds": 1000000000,
					"parsed_script": "OP_PUSHDATA0(65) 04ae1a62fe09c5f51b13905f07f06b99a2f7159b2225f374cd378d71302fa28414e7aab37397f554a7df5f142c21c1b7303b8a0626f1baded5c72a704f7e6cd84c OP_CHECKSIG", # push pubkey op_checksig
					"script_length": 67
				},
				1: {
					"funds": 4000000000,
					"parsed_script": "OP_PUSHDATA0(65) 0411db93e1dcdb8a016b49840f8c53bc1eb68a382e97b1482ecad7b148a6909a5cb2e0eaddfb84ccf9744464f82e160bfa9b8b64f9d4c03f999b8643f656b412a3 OP_CHECKSIG", # push pubkey op_checksig
					"script_length": 67
				}
			},
			"version": 1
		...
		"on_txin_num": 0,
		"prev_txout_parsed_script": "OP_PUSHDATA0(65) 0411db93e1dcdb8a016b49840f8c53bc1eb68a382e97b1482ecad7b148a6909a5cb2e0eaddfb84ccf9744464f82e160bfa9b8b64f9d4c03f999b8643f656b412a3 OP_CHECKSIG" # push pubkey op_checksig
	},
	# standard pay to pubkey hash tx with a single input
	1: {
		"later_tx": {
			"hash": "27f3727e0915a71cbe75dd9d5ded9d8161a82c0b81a3b60f5fff739cdd77fd51",
			"num_inputs": 1,
			"input": {
				0: {
					"funds": 100000000,
					"hash": "2a2ea9f8a3558acb58c0a737d03ddeb36e6f00f0ff9db7d87622c89caf3a6ba3",
					"index": 72,
					"parsed_script": "OP_PUSHDATA0(73) 3046022100c4c87ea101d43c220ffdeb6ac1cc834c5b43c77ae1f4e809d7a6dd8149dfeed5022100f08a2935a7f21188ef03ee69dd78ed6910ffa83239d82e3d03cd7305e28f92c001 OP_PUSHDATA0(65) 04d81236eb62fc1ac66a6192a7ca6762d09730eebd898a6c485ce48d0b6c3245f5e4638a87e7d94bb07e6fc0f250aefe8f1c426320e86de6e7079bccc1827d2642", # push signature push pubkey 
					"script_length": 140,
					"sequence_num": 4294967295
				}
			},
			...
			"output": {
				0: {
					"funds": 100000000,
					"parsed_script": "OP_DUP OP_HASH160 OP_PUSHDATA0(20) 8bca4a44c14c181e4391c750c0c6d8b1b1a5bd5f OP_EQUALVERIFY OP_CHECKSIG",
					"script_length": 25
				}
			},
			"version": 1
		...
		"on_txin_num": 0,
		"prev_txout_parsed_script": "OP_DUP OP_HASH160 OP_PUSHDATA0(20) 83b7202a69e6792a4160fff89f126a8ce9a68b71 OP_EQUALVERIFY OP_CHECKSIG"
	},
	# a tx with multiple inputs
	2: {
		"later_tx": {
			"hash": "dfc95e050b8d6dc76818ef6e1f117c7631cc971f86da4096efdf72434a1ef6be",
			"num_inputs": 4,
			"input": {
				0: {
					"funds": 100000000,
					"hash": "cd245e9df44b7985c5ecd3dfe2ecfc5f0dcab6bf3c5c70e327e74bbbcc8fc073",
					"index": 1,
					"parsed_script": "OP_PUSHDATA0(72) 3045022012f400de6d1bd1e419c9359b9c4f1655c90b0733655590a86831f39aadf71bf5022100bee09e63962779f77ee9cecdffc07c5877ce006b9b71d67ad528ffa319a54bbf01 OP_PUSHDATA0(65) 04ba7218c27fa3ce013a33895a3511853f4765115bfc9a104ea83578df42ef14938b828775c55ca467b279b8ba3208d3b772ede39496a321e338b4c3dc5498fb87",
					"script_length": 139,
					"sequence_num": 4294967295
				},
				1: {
					"funds": 499000000,
					"hash": "cc27aeb6324103edf80b0a5af5517789b74b3589b1f3c991048b299ce460c15c",
					"index": 1,
					"parsed_script": "OP_PUSHDATA0(72) 304502207fa17a8131e287ad2b670b1ccc19baff5aef195075b2593442592ed005a9e2e9022100e2003d9bc349de0b0b46f5f662fb5184f78dcbde0f8091ad78b1e9e0f0ac5bea01 OP_PUSHDATA0(65) 04ba7218c27fa3ce013a33895a3511853f4765115bfc9a104ea83578df42ef14938b828775c55ca467b279b8ba3208d3b772ede39496a321e338b4c3dc5498fb87",
					"script_length": 139,
					"sequence_num": 4294967295
				},
				2: {
					"funds": 100000000,
					"hash": "14491fcd7e1a565ba3efefce221c5c053960990ab71a7c92432af627646db7ea",
					"index": 1,
					"parsed_script": "OP_PUSHDATA0(72) 30450220265200e6503220f03580c58b37b7eee0b9f6ade73481d2670f9c0264c5f98286022100ea29047189aebca045f15a6659f2f763f3e21da6df2e6fbfdc0b0084bee2456301 OP_PUSHDATA0(65) 048c25ca93acbea114e093d19bf1ae7f55a03808d27c8f99265b3293d43dcb1fb3d2a3a42cb2d2e49e5b0057004870b35923ce6f697a656ca5a94cc63d7acb96e5",
					"script_length": 139,
					"sequence_num": 4294967295
				},
				3: {
					"funds": 318932500,
					"hash": "bb0040b5bfd2725fb4d1e6fd80b05da627b9196b6826f61f9d866c083e53962f",
					"index": 0,
					"parsed_script": "OP_PUSHDATA0(72) 3045022061845669092e5647781e703f68b0629d23402b537e7ee9ca7d67bfad5ddea3e10221009e9b5d63ace5935989170f6305f15f602ddb45d5b609291b2bb8385613ab8e5201 OP_PUSHDATA0(65) 04296c15d4590d7c568e095cfdebabf0b0e122f93a3b1ced67d558bd1132d81278d3430af5e86c4b41b0221b0374558d08724777bfadc3c9d84ed661496abd40cf",
					"script_length": 139,
					"sequence_num": 4294967295
				}
			},
			...
			"output": {
				0: {
					"funds": 27882500,
					"parsed_script": "OP_DUP OP_HASH160 OP_PUSHDATA0(20) a4b5e56a72c5d47e08887cc0f221d4c8fb1c97d8 OP_EQUALVERIFY OP_CHECKSIG",
					"script_length": 25
				},
				1: {
					"funds": 990000000,
					"parsed_script": "OP_DUP OP_HASH160 OP_PUSHDATA0(20) 5bb3361bb5d33d9e556bbfa5da5445997b7b9d66 OP_EQUALVERIFY OP_CHECKSIG",
					"script_length": 25
				}
			},
			"version": 1
		...
		"on_txin_num": 2,
		"prev_txout_parsed_script": "OP_DUP OP_HASH160 OP_PUSHDATA0(20) 30c6c99201fa61f3fe3ef4f1e1a53432651251b8 OP_EQUALVERIFY OP_CHECKSIG"
	},
	...
	3: {
		"later_tx": {
			...
			"input": {
				0: {
					...
					"index": 0,
					"parsed_script": "OP_PUSHDATA0(72) 304502205b282fbc9b064f3bc823a23edcc0048cbb174754e7aa742e3c9f483ebe02911c022100e4b0b3a117d36cab5a67404dddbf43db7bea3c1530e0fe128ebc15621bd69a3b01 OP_PUSHDATA0(33) 035aa98d5f77cd9a2d88710e6fc66212aff820026f0dad8f32d1f7ce87457dde50", # push signature push pubkey
					"script_length": 107,
					"sequence_num": 4294967295
				},
			...
			"output": {
				0: {
					"funds": 1900000,
					"parsed_script": "OP_DUP OP_HASH160 OP_PUSHDATA0(20) 380cb3c594de4e7e9b8e18db182987bebb5a4f70 OP_EQUALVERIFY OP_CHECKSIG",
					"script_length": 25
				},
				1: {
					"funds": 3000000,
					"parsed_script": "OP_PUSHDATA0(20) 2a9bc5447d664c1d0141392a842d23dba45c4f13 OP_NOP2 OP_DROP",
					"script_length": 23
				}
			},
			"version": 1
		...
		"on_txin_num": 1,
		"prev_txout_parsed_script": "OP_PUSHDATA0(20) 2a9bc5447d664c1d0141392a842d23dba45c4f13 OP_NOP2 OP_DROP" # push bytes nop drop-bytes
	}
}
explain = True
...
""" % test_num
	...
	for (txin_num, txin) in tx["input"].items():
		tx["input"][txin_num]["hash"] = btc_grunt.hex2bin(tx["input"][txin_num]["hash"])
	...
	for (txout_num, txout) in tx["output"].items():
		...
		tx["output"][txout_num]["script"] = btc_grunt.script_list2bin(script_list)

	prev_txout_script_list = btc_grunt.human_script2bin_list(data["prev_txout_parsed_script"])
